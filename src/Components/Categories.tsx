    ...
    return(<>
        ...
        <div className="mt-2 mb-8 flex flex-col justify-center md:grid grid-cols-3" >
                <div className="h-36 min-w-64 m-4 rounded-lg relative
                    ...
                    <img src={DessertImg} className="w-full h-full" alt="loading"/>
                ...
                <div className="h-36 min-w-64 m-4 rounded-lg relative
                    ...
                    <img src={PastaImg} className="w-full h-full" alt="loading"/>
                ...
                <div className="h-36 min-w-64 m-4 rounded-lg relative
                    ...
                    <img src={SeafoodImg} className="w-full h-full" alt="loading"/>
                ...
                <div className="h-36 min-w-64 m-4 rounded-lg relative
                    ...
                    <img src={ChickenImg} className="w-full h-full" alt="loading"/>
                ...
                <div className="h-36 min-w-64 mx-4 mt-4 mb-6 rounded-lg relative
                    ...
                    <img src={VeganImg} className="w-full h-full" alt="loading"/>
